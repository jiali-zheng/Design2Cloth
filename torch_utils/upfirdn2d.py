...
def upsample2d(x, f, up=2, padding=0, flip_filter=False, gain=1, impl='cuda'): #up was 2
# def upsample2d(x, f, up=4, padding=0, flip_filter=False, gain=1, impl='cuda'): #up was 2
